...
<div class="card mb-4 mt-4">
    <div class="card-header">
        ...
        Update Manager
        <a href="{{url('manager')}}" class="float-end btn btn-sm btn-success">View All</a>
    </div>
    <div class="card-body">
        ...
        @endif
        <form method="post" action="{{url('manage/'.$data->id)}}" enctype="multipart/form-data">
            @method('put')
            @csrf
            <table class="table table-bordered">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <p>
                            <img src="{{asset('public/images/'.$data->photo)}}" width="200" style="border-radius: 12px" />
